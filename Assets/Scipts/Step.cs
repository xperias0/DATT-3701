...
public class Step : MonoBehaviour
{
    ...
    public float menuStartPosition = 1600.0f;
    ...
    void Update()
    {
        if (Input.GetKey(KeyCode.JoystickButton6))
        {
            ...
            float newY = Mathf.Lerp(pauseMenuPanel.transform.position.y, menuTargetY + 650, Time.deltaTime * menuSpeed);
            ...
            Guildlines.transform.position = new Vector3(pauseMenuPanel.transform.position.x, newY +300, pauseMenuPanel.transform.position.z); ;
